...
<head>
    ...
    <script type="text/javascript" src="/scripts/GalleryController.js"></script>
    <script type="text/javascript" src="/scripts/Navigation.js"></script>
    <link href="/styles/gallery.css" type="text/css" rel="stylesheet"/>
    <link href="/styles/reset.css" type="text/css" rel="stylesheet"/>
    <script type="text/javascript">
        $(function () {
            new braxis.GalleryController().initialise();
...
<#list model.images as image>
    <li class="image">
        <img id="${image.id}" src="${image.mainUrl}" alt="${image.name}"/>
    </li>
</#list>
</div>
